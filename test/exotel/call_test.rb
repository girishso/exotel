...
describe Exotel::Call do
  ...
  describe '.connect_to_flow' do
    ...
    describe 'success' do
      before do
        ...
        WebMock.stub_request(:post, "https://test_sid:test_token@twilix.exotel.in/v1/Accounts/#{Exotel.exotel_sid}/Calls/connect").
      ...
      it "should set the response object values" do
        ...
        json['Sid'].must_equal 'CAe1644a7eed5088b159577c5802d8be38'
        json['DateCreated'].must_equal 'Tue, 10 Aug 2010 08:02:17'
        json['DateUpdated'].must_equal 'Tue, 10 Aug 2010 08:02:47'
        json['StartTime'].must_equal  'Tue, 10 Aug 2010 08:02:31 +0000'
        json['EndTime'].must_equal  'Tue, 10 Aug 2010 08:02:47 +0000'
        json['Status'].must_equal 'completed'
        json['From'].must_equal '01234'
        json['To'].must_equal '04321'
      end
    end
  ...
  describe '#details' do
    before do
      base_path = File.expand_path(File.join(File.dirname(__FILE__), '..'))
      WebMock.stub_request(:get, "https://test_sid:test_token@twilix.exotel.in/v1/Accounts/#{Exotel.exotel_sid}/Calls/CAe1644a7eed5088b159577c5802d8be38").
      to_return(:status => 200, :body => File.new(base_path + '/fixtures/call.xml'))
    end
