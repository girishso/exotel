...
=end
  ...
  describe '#send' do
    describe 'success' do
      before do
        ...
        WebMock.stub_request(:post, "https://test_sid:test_token@twilix.exotel.in/v1/Accounts/#{Exotel.exotel_sid}/Sms/send").
  ...
  describe '#details' do
    describe 'success' do
      before do
        base_path = File.expand_path(File.join(File.dirname(__FILE__), '..'))
        WebMock.stub_request(:get, "https://test_sid:test_token@twilix.exotel.in/v1/Accounts/#{Exotel.exotel_sid}/Sms/Messages/SM872fb94e3b358913777cdb313f25b46f").
        to_return(:status => 200, :body => File.new(base_path + '/fixtures/sms.xml'))
      end
